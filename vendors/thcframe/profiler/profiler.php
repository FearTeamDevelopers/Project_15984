...
class Profiler
{
    ...
    public function end($identifier = 'run')
    {
        if ($this->_enabled) {
            ...
            $str = '<link href="/public/css/profiler.css" media="screen" rel="stylesheet" type="text/css" /><div id="profiler">';
            ...
            $str .= '</table></div>';
            $str .= '</div><script type="text/javascript" src="/public/js/custom/profiler.js"></script>';
